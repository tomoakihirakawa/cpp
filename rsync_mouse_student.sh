...
rsync -vr --exclude "CMake*" --exclude "main" --exclude "*.vtu" --exclude "*.obj" --exclude "*.mov" /Users/tomoaki/Dropbox/markdown/cpp/builds/build_octree/* ${name}/research/cpp/builds/build_octree/
