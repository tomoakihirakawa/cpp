...
rsync --update -vr --exclude "CMake*" --exclude "main" --exclude "*.vtu" /Users/tomoaki/Dropbox/markdown/cpp/obj/Multipl* ${name}/research/cpp/obj/Multipl*
...
rsync --update -vr --exclude "CMake*" --exclude "main" --exclude "*.vtu" /Users/tomoaki/Dropbox/markdown/cpp/builds/build_octree/* ${name}/research/cpp/builds/build_octree/
rsync --update -vr --exclude "CMake*" --exclude "main" --exclude "*.vtu" /Users/tomoaki/Dropbox/markdown/cpp/builds/build_divide_merge/* ${name}/research/cpp/builds/build_divide_merge/
