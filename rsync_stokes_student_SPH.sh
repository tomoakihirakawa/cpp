...
rsync --update -vr --exclude "*.vtu" --exclude "*.vtp" --exclude "CMake*" --exclude "main" --exclude "*.nb" --exclude "*.json" --exclude "*.mov" /Users/tomoaki/Dropbox/markdown/cpp/builds/build_sph/* ${name}/research/cpp/builds/build_sph/
...
# rsync --update -vr --exclude "CMake*" --exclude "main" /Users/tomoaki/Dropbox/markdown/cpp/obj/2022Arai ${name}/research/cpp/obj/
