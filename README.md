...
- [🐋 線と三角形の干渉判定](./builds/build_Network/README.md#🐋-線と三角形の干渉判定)
    - [⛵ 等間隔のシンプルな空間分割](./builds/build_Network/README.md#⛵-等間隔のシンプルな空間分割)
...
## [build_sph_back](./builds/build_sph_back/README.md)

- [Contents](./builds/build_sph_back/README.md#Contents)
- [🐋 Smoothed Particle Hydrodynamics (SPH) ISPH EISPH](./builds/build_sph_back/README.md#🐋-Smoothed-Particle-Hydrodynamics-(SPH)-ISPH-EISPH)
    - [⛵ 概要](./builds/build_sph_back/README.md#⛵-概要)
    - [⛵ N.S.方程式を解く前の準備](./builds/build_sph_back/README.md#⛵-N.S.方程式を解く前の準備)
    - [⛵ N.S.方程式を解く前の準備](./builds/build_sph_back/README.md#⛵-N.S.方程式を解く前の準備)
    - [⛵ 粘性項$`\nabla^2 {\bf u} _i`$の計算（`calcLaplacianU`）](./builds/build_sph_back/README.md#⛵-粘性項$`\nabla^2-{\bf-u}-_i`$の計算（`calcLaplacianU`）)
    - [⛵ ポアソン方程式 $`\nabla ^{n+1} \cdot \left(\frac{1}{\rho ^n} \nabla ^{n} p \right)=b`$](./builds/build_sph_back/README.md#⛵-ポアソン方程式-$`\nabla-^{n+1}-\cdot-\left(\frac{1}{\rho-^n}-\nabla-^{n}-p-\right)=b`$)
    - [⛵ ポアソン方程式の解法](./builds/build_sph_back/README.md#⛵-ポアソン方程式の解法)
    - [⛵ 圧力勾配$`\nabla p^{n+1}`$の計算](./builds/build_sph_back/README.md#⛵-圧力勾配$`\nabla-p^{n+1}`$の計算)
    - [⛵ 注意点](./builds/build_sph_back/README.md#⛵-注意点)
    - [⛵ 出力](./builds/build_sph_back/README.md#⛵-出力)
    - [⛵ 出力（ポリゴン）](./builds/build_sph_back/README.md#⛵-出力（ポリゴン）)
- [🐋 実行方法](./builds/build_sph_back/README.md#🐋-実行方法)
- [🐋 Bucketを用いた粒子探索のテスト](./builds/build_sph_back/README.md#🐋-Bucketを用いた粒子探索のテスト)
- [🐋 テスト](./builds/build_sph_back/README.md#🐋-テスト)
    - [⛵ 核関数のテスト](./builds/build_sph_back/README.md#⛵-核関数のテスト)
