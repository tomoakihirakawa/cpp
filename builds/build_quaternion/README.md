...
\end{bmatrix}
$$
[:material-microsoft-visual-studio-code:../../include/basic_vectors.hpp#L1349](vscode://file//Users/tomoaki/Library/CloudStorage/Dropbox/code/cpp/include/basic_vectors.hpp:1349)
...
[:material-microsoft-visual-studio-code:validateRotation.cpp#L5](vscode://file//Users/tomoaki/Library/CloudStorage/Dropbox/code/cpp/builds/build_quaternion/validateRotation.cpp:5)
...
$$
\begin{aligned}
{\mathbfit q}^{t+\delta t} &= {\mathbfit q}^{t} * {\mathbfit q}((1,0,0),w _x \delta t) * {\mathbfit q}((0,1,0),w _y \delta t) * {\mathbfit q}((0,0,1),w _z \delta t)\\
\rightarrow \frac{{\mathbfit q}^{t+\delta t} - {\mathbfit q}^{t}}{\delta t} &= \frac{{\mathbfit q}^{t} * {\mathbfit q}((1,0,0),w _x \delta t) * {\mathbfit q}((0,1,0),w _y \delta t) * {\mathbfit q}((0,0,1),w _z \delta t) - {\mathbfit q}^{t}}{\delta t}
\end{aligned}
$$
...
[:material-microsoft-visual-studio-code:../../include/basic_vectors.hpp#L1644](vscode://file//Users/tomoaki/Library/CloudStorage/Dropbox/code/cpp/include/basic_vectors.hpp:1644)
...
[:material-microsoft-visual-studio-code:../../include/basic_vectors.hpp#L1786](vscode://file//Users/tomoaki/Library/CloudStorage/Dropbox/code/cpp/include/basic_vectors.hpp:1786)

[:material-microsoft-visual-studio-code:validateAngularVelocity.cpp#L5](vscode://file//Users/tomoaki/Library/CloudStorage/Dropbox/code/cpp/builds/build_quaternion/validateAngularVelocity.cpp:5)
