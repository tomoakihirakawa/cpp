...
[DampedHrmonicOscillator:declOfAccel](./example_DampedHarmonicOscillator.cpp#L51)し，
...
時間間隔$`\Delta t`$が変化する場合でも使える形でプログラムしている（[ODE:LeapFrog](../../include/integrationOfODE.hpp#L491)）．
$\Delta t$が変化する場合，"半分蹴って-移動-半分蹴って"，"半分蹴って-移動-半分蹴って"の手順を繰り返す．
[ODE:LeapFrog](../../include/integrationOfODE.hpp#L491)
...
[ODE:RungeKutta](../../include/integrationOfODE.hpp#L34)
