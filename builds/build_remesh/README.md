...
[canFlip](../../include/networkLine.hpp#L1502)でフリップ可能かどうかを判定する．直感的に次のような条件の場合，境界面が崩れるため，フリップさせたくない．
...
信頼できる三角形の判定には，[isValidTriangle](../../include/basic_vectors.hpp#L2093)を用いる．
...
`canFlip`と同様，[isValidTriangle](../../include/basic_vectors.hpp#L2093)を用いる．
