...
周波数領域解析は以下のような流れである（[Kashiwagi et al. (2005)](https://linkinghub.elsevier.com/retrieve/pii/S0029801804002252)，[柏木 (2004)](https://www.jstage.jst.go.jp/article/technom/880/0/880{\_}KJ00001033371/{\_}article/-char/ja/)を参考）
...
<figure>
<img src="/REVIEW/computer_memory.png"/>
<figcaption>現在，メモリ容量は，以前と比べて格段に大きくなり，メモリの節約を考える必要がなくなった．</figcaption>
</figure>
...
[:material-microsoft-visual-studio-code:REVIEW.md#L1](vscode://file//Users/tomoaki/Library/CloudStorage/Dropbox/code/cpp/builds/build_bem/REVIEW.md:1)
...
[Feng and Bai (2017)](https://linkinghub.elsevier.com/retrieve/pii/S0889974616300482)も指摘するように，以上のBEM周波数領域解析は，線型理論であるため波が激しい場合の精度には疑問が残る．
ポテンシャルを，入射，散乱，放射のポテンシャルに分離し問題を簡単化した結果，計算結果が実際と大きくずれる可能性がある．

例えば，Radiationポテンシャルは浮体動揺から切り離されているが，実際は，速度ポテンシャル自体が浮体動揺に応じて変化し，さらにポテンシャルから計算される力自体も浮体姿勢に応じて変化する．

**粘性の無視**

構造物付近では粘性が流れや構造物に働く流体力に大きく影響する可能性がある．
...
[:material-microsoft-visual-studio-code:REVIEW_NOTE0_org.md#L1](vscode://file//Users/tomoaki/Library/CloudStorage/Dropbox/code/cpp/builds/build_bem/REVIEW_NOTE0_org.md:1)
