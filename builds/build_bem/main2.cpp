...
#define area_averaged_tension
            ...
            // p->U_update_BEM = p->U_normal_BEM + K * tension; // p->U_normal_BEM + tangent; //要修正．EMTをプログラム
...
#pragma omp parallel for
...
#ifdef USE_LAPACK_BLAS
        std::cout << "lapack_lu decomposition" << std::endl;
        this->lu = new lapack_lu(mat_ukn /*未知の行列係数（左辺）*/);
#else
        std::cout << "ludcmp_parallel decomposition" << std::endl;
        ...
        {
            phiORphin = V_d(phiORphin.size(), 0.);
