...
SimulationCase = "Tonegawa20221216"
match SimulationCase:
    case "tsukada_floting_body_test":
        settingBEM["max_dt"] = 0.2
        settingBEM["output_directory"] = home + \
            "/BEM/2022Tsukada_flotingbody_without_moonpool_A0d75T7d0"
        settingBEM["inputfiles"] = ["water.json",
                                    "floatingbody.json",
                                    "wavemaker.json",
                                    "wavetank.json"]
        objfolder = "tsukada2022_re"
        water["objfile"] = "../../obj/"+objfolder+"/"+"water100_mod.obj"
        wavemaker["objfile"] = "../../obj/"+objfolder+"/"+"wavemaker200.obj"
        wavetank["objfile"] = "../../obj/"+objfolder+"/"+"wavetank10.obj"
        wavetank_ignore = False

        floatingbody["objfile"] = "../../obj/" + \
            objfolder+"/"+"floatingbody100.obj"

        # A = 2428.00
        # A = 2428.00
        A = 2450.00
        floatingbody["mass"] = m = (1000.*g*7.5*A)/g*1.1
        # floatingbody["COM"] = [200., 75., 75.]
        floatingbody["COM"] = [100., 50., 75.]
        # floatingbody["radius of gyration"] = [18.7, 20.3, 21.1]
        floatingbody["radius of gyration"] = [20., 20., 20.]
        # floatingbody["radius of gyration"] = [30., 30., 30.]
        ...
        wavetank["isFixed"] = True
        wavemaker["isFixed"] = True
        wavemaker["type"] = "SoftBody"
        wavemaker["velocity"] = [
            "linear_traveling_wave", start, a, T, h, z_surface]
    case "Tonegawa20221216":
        ...
        settingBEM["inputfiles"] = ["water.json",
                                    ...
                                    "wavemaker.json",
                                    "wavetank.json"]
        objfolder = "/Users/tomoaki/Dropbox/markdown/cpp/obj/2022Tonegawa/test20221218"
        water["objfile"] = objfolder + "/water150_mod.obj"
        wavemaker["objfile"] = objfolder + "/wavemaker100.obj"
        wavetank["objfile"] = objfolder + "/wavetank10.obj"
        ...
        inputfiles = [wavetank, wavemaker, water, floatingbody]
        settingBEM = {
            "max_dt": 0.2,
            "output_directory": home + "/BEM/2022Tonegawa",
            "inputfiles": [x["name"]+".json" for x in inputfiles]
        }
    ...
    case "wave_generation_test":
        ...
        wavemaker["objfile"] = "../../obj/"+objfolder+"/"+"wavemaker300.obj"
        ...
        z_surface = 140
        wavemaker["type"] = "SoftBody"
        wavemaker["velocity"] = ["weird", start, a, T, h, z_surface]
    case "FloatingWind1":
        ...
        # wavemaker["velocity"] = ["Chaplin2000", 0.1, .01, 5*math.pi/5.]
