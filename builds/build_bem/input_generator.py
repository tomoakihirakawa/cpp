...
if "Cheng2018" in SimulationCase:
    ...
    Iyy = 0.1967978007   # 密度1.18g/cm^3と質量から計算，{Ixx,Iyy,Izz}={0.3034752725,0.1967978007,0.3692731657}
    ...
    dx = 0.6
    for i in range(10):
        gauges.append({"name": "gauge"+str(i), "type": "wave gauge", "position": [0. + dx*i, 0, 1.1, 0. + dx*i, 0, 1.1-0.6]})
