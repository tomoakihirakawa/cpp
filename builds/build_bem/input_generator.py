...
if "looping" in SimulationCase:
    ...
    ```sh
    python3.11 input_generator.py DeepCWind -dt [時間刻み幅] -H [波高] -L [波長] -o [出力先ディレクトリ] -s [接尾語]
    python3.11 input_generator.py DeepCWind -dt 0.5 -H 7.4 -o /Volumes/home/BEM/2025海洋開発論文集/ -s 4floats
    ```
    ...
    # trialはかならず指定すること．さもなくばエラー
    if trial == "":
        print("Error: please specify the trial name in suffix")
        sys.exit()
    else:
        # もし，_があれば_以降を除去する
        if "_" in trial:
    ...
    generate_input_files(inputfiles, setting, IO_dir, id)
elif "Yeh2010" in SimulationCase:

    r'''DOC_EXTRACT 2_2_0_validation_Yeh2010
    ...
    objfolder = code_home_dir + "/cpp/obj/Yeh2010/"
