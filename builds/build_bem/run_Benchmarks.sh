...
python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e pseudo_quad -ALE pseudo_quad -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial09
python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e pseudo_quad -ALE linear -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial09
python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e linear -ALE pseudo_quad -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial09
python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e linear -ALE linear -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial09

python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e pseudo_quad -ALE pseudo_quad -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial08
python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e pseudo_quad -ALE linear -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial08
python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e linear -ALE pseudo_quad -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial08
python3 input_generator.py Ruehl2016 -m water0d11.obj -dt 0.1 -e linear -ALE linear -ALEPERIOD 1 -o /Volumes/home/BEM/benchmark20250501 -s Trial08
...
./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMpseudo_quad_ALEpseudo_quad_ALEPERIOD1_Trial09
./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMlinear_ALEpseudo_quad_ALEPERIOD1_Trial09
./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMlinear_ALElinear_ALEPERIOD1_Trial09
./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMpseudo_quad_ALElinear_ALEPERIOD 1_Trial09

# 1. バケツがfaceを保持していないか，この場合少しのジャンプだろう（おそらくこっちか）
# 2. 保持していたとしても，バケツ自体を取り出せていないかもしれない．この場合大きなジャンプが生じていただろう
# 結果で確認．

./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMpseudo_quad_ALEpseudo_quad_ALEPERIOD1_Trial08
./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMlinear_ALEpseudo_quad_ALEPERIOD1_Trial08
./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMlinear_ALElinear_ALEPERIOD1_Trial08
./fast ./input_files/Ruehl2016_DT0d1_MESHwater0d11.obj_ELEMpseudo_quad_ALElinear_ALEPERIOD1_Trial08
