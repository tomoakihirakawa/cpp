...
[./SPH_Functions.hpp#L184](./SPH_Functions.hpp#L184)
...
[./SPH0_setWall_Freesurface.hpp#L64](./SPH0_setWall_Freesurface.hpp#L64)

## ⛵ N.S.方程式を解く前の準備

[./SPH0_setWall_Freesurface2.hpp#L64](./SPH0_setWall_Freesurface2.hpp#L64)

## ⛵ N.S.方程式を解く前の準備

[./SPH_setWall_Freesurface_changed.hpp#L11](./SPH_setWall_Freesurface_changed.hpp#L11)
...
プログラム上では[`grad_corr_M`](../../builds/build_sph/SPH_setWall_Freesurface_changed.hpp#L71)としている．
...
[./SPH0_setWall_Freesurface.hpp#L72](./SPH0_setWall_Freesurface.hpp#L72)
...
[./SPH0_setWall_Freesurface.hpp#L280](./SPH0_setWall_Freesurface.hpp#L280)
...
[./SPH0_setWall_Freesurface2.hpp#L72](./SPH0_setWall_Freesurface2.hpp#L72)
...
[./SPH0_setWall_Freesurface2.hpp#L278](./SPH0_setWall_Freesurface2.hpp#L278)
...
[./SPH_setWall_Freesurface_changed.hpp#L19](./SPH_setWall_Freesurface_changed.hpp#L19)
...
[./SPH_setWall_Freesurface_changed.hpp#L165](./SPH_setWall_Freesurface_changed.hpp#L165)
...
[./SPH0_setWall_Freesurface.hpp#L499](./SPH0_setWall_Freesurface.hpp#L499)

#### 🐚 `setCorrectionMatrix`で壁粒子の演算修正用行列を計算 

`setCorrectionMatrix`で壁粒子の演算修正用行列を計算する．

[./SPH0_setWall_Freesurface.hpp#L575](./SPH0_setWall_Freesurface.hpp#L575)

### 🪼 壁面粒子の抽出と値の計算

[./SPH0_setWall_Freesurface.hpp#L606](./SPH0_setWall_Freesurface.hpp#L606)
...
[./SPH0_setWall_Freesurface.hpp#L647](./SPH0_setWall_Freesurface.hpp#L647)
...
[./SPH0_setWall_Freesurface2.hpp#L497](./SPH0_setWall_Freesurface2.hpp#L497)

#### 🐚 `setCorrectionMatrix`で壁粒子の演算修正用行列を計算 

`setCorrectionMatrix`で壁粒子の演算修正用行列を計算する．

[./SPH0_setWall_Freesurface2.hpp#L573](./SPH0_setWall_Freesurface2.hpp#L573)

### 🪼 壁面粒子の抽出と値の計算

[./SPH0_setWall_Freesurface2.hpp#L604](./SPH0_setWall_Freesurface2.hpp#L604)
...
[./SPH0_setWall_Freesurface2.hpp#L645](./SPH0_setWall_Freesurface2.hpp#L645)
...
[./SPH_setWall_Freesurface_changed.hpp#L369](./SPH_setWall_Freesurface_changed.hpp#L369)

#### 🐚 `setCorrectionMatrix`で壁粒子の演算修正用行列を計算 

`setCorrectionMatrix`で壁粒子の演算修正用行列を計算する．

[./SPH_setWall_Freesurface_changed.hpp#L445](./SPH_setWall_Freesurface_changed.hpp#L445)

### 🪼 壁面粒子の抽出と値の計算

[./SPH_setWall_Freesurface_changed.hpp#L476](./SPH_setWall_Freesurface_changed.hpp#L476)
...
[./SPH_setWall_Freesurface_changed.hpp#L517](./SPH_setWall_Freesurface_changed.hpp#L517)
...
[./SPH0_setWall_Freesurface2.hpp#L513](./SPH0_setWall_Freesurface2.hpp#L513)
...
[./SPH_setWall_Freesurface_changed.hpp#L385](./SPH_setWall_Freesurface_changed.hpp#L385)

---
### 🪼 流体の法線方向の計算と水面の判定

[./SPH0_setWall_Freesurface.hpp#L706](./SPH0_setWall_Freesurface.hpp#L706)

#### 🐚 流体の法線方向の計算 

✅ [単位法線ベクトル](../../builds/build_sph/SPH_setWall_Freesurface_changed.hpp#L718): $`{\bf n} _i = {\rm Normalize}\left(-\sum _j {\frac{m _j}{\rho _j} \nabla W _{ij} }\right)`$

単位法線ベクトルは，`interp_normal`としている．

[./SPH0_setWall_Freesurface.hpp#L736](./SPH0_setWall_Freesurface.hpp#L736)
...
[./SPH0_setWall_Freesurface2.hpp#L704](./SPH0_setWall_Freesurface2.hpp#L704)
...
[./SPH0_setWall_Freesurface2.hpp#L727](./SPH0_setWall_Freesurface2.hpp#L727)

#### 🐚 水面の判定 

水面の判定条件は，少し複雑である．

[./SPH0_setWall_Freesurface2.hpp#L987](./SPH0_setWall_Freesurface2.hpp#L987)

### 🪼 流体の法線方向の計算と水面の判定

[./SPH_setWall_Freesurface_changed.hpp#L576](./SPH_setWall_Freesurface_changed.hpp#L576)
...
[./SPH_setWall_Freesurface_changed.hpp#L599](./SPH_setWall_Freesurface_changed.hpp#L599)

#### 🐚 水面の判定 

水面の判定条件は，少し複雑である．

[./SPH_setWall_Freesurface_changed.hpp#L860](./SPH_setWall_Freesurface_changed.hpp#L860)

---
## ⛵ 粘性項$`\nabla^2 {\bf u} _i`$の計算（`calcLaplacianU`） 

✅ [流速のラプラシアンの計算方法](../../builds/build_sph/SPH1_lap_div_U.hpp#L119): $`\nabla^2 {\bf u} _i=\sum _{j} A _{ij}({\bf u} _i - {\bf u} _j),\quad A _{ij} = \frac{2m _j}{\rho _i}\frac{{{\bf x} _{ij}}\cdot\nabla W _{ij}}{{\bf x} _{ij}^2}`$

✅ [流速の発散の計算方法](../../builds/build_sph/SPH1_lap_div_U.hpp#L101): $`\nabla\cdot{\bf u} _i=\sum _{j}\frac{m _j}{\rho _j}({{\bf u} _j-{\bf u} _i}) \cdot\nabla W _{ij}`$
...
$`{\bf b}^n`$ （[`Poisson_b_vector`](../../builds/build_sph/SPH1_lap_div_U.hpp#L256)）が計算できるように，$`{\bf u}^n`$と$`\nabla^2 {\bf u}^n`$を計算しておく．
...
そこで，[水面の計算補助粒子](../../include/Network.hpp#L562)を水面外部に追加し，この点を適切計算することで，$`\nabla^{n+1} {\bf u}^{n+1}=0`$が満足されるように工夫する．
--->
...
* [次時刻の粒子体積](../../builds/build_sph/SPH_Functions.hpp#L319)
* [次時刻の粒子密度](../../builds/build_sph/SPH_Functions.hpp#L307)
* [次時刻の粒子位置](../../builds/build_sph/SPH_Functions.hpp#L322)
...
|方程式|目的|
|:---------|---|
| ☑️ [ポアソン方程式](../../builds/build_sph/SPH2_FindPressure.hpp#L238)              | 次時刻の流速の発散をゼロにする（非圧縮性を満たす）ように圧力を決定する． |
...
[./SPH2_FindPressure.hpp#L328](./SPH2_FindPressure.hpp#L328)
...
[./SPH2_FindPressure.hpp#L375](./SPH2_FindPressure.hpp#L375)

---
## ⛵ ポアソン方程式の解法 

ISPHのポアソン方程式を解く場合，[ここではGMRES法](../../builds/build_bem/BEM_solveBVP.hpp#L968)を使う．

[./SPH2_FindPressure.hpp#L476](./SPH2_FindPressure.hpp#L476)

---
## ⛵ 圧力勾配$`\nabla p^{n+1}`$の計算 

✅ [勾配の計算方法](../../builds/build_sph/SPH3_grad_P.hpp#L162): $`\nabla p _i = \rho _i \sum _{j} m _j (\frac{p _i}{\rho _i^2} + \frac{p _j}{\rho _j^2}) \nabla W _{ij}`$

✅ [勾配の計算方法](../../builds/build_sph/SPH3_grad_P.hpp#L116): $`\nabla p _i = \sum _{j} \frac{m _j}{\rho _i} \left(p _j - p _i\right) \nabla W _{ij}`$

✅ [勾配の計算方法](../../builds/build_sph/SPH3_grad_P.hpp#L127): $`\nabla p _i = \sum _{j} \frac{m _j}{\rho _j} p _j \nabla W _{ij}`$
...
[./SPH3_grad_P.hpp#L167](./SPH3_grad_P.hpp#L167)
...
- [壁粒子の速度の決定方法](../../builds/build_sph/SPH_setWall_Freesurface_changed.hpp#L565)
- [Poissonにおいてどのようにbベクトルを使うか](not found)
- [Poissonにおいてどのようにbベクトルを使うか](not found)
- どのように[壁粒子のb](not found)/[流体粒子のb](../../builds/build_sph/SPH1_lap_div_U.hpp#L257)を作るか

**壁粒子**

- [壁粒子のラプラシアンの計算方法](../../builds/build_sph/SPH1_lap_div_U.hpp#L255)
- [圧力の計算方法](../../builds/build_sph/SPH2_FindPressure.hpp#L127)
- [どの位置において方程式を立てるか](../../builds/build_sph/SPH2_FindPressure.hpp#L290)
- [流体として扱う壁粒子を設定するかどうか](../../builds/build_sph/SPH_setWall_Freesurface_changed.hpp#L360)/[視野角に流体粒子が含まない壁粒子は除外する](not found)
- [壁粒子の圧力をどのように壁面にマッピングするか](not found)
- [壁粒子の法線方向ベクトルの計算方法](../../builds/build_sph/SPH_setWall_Freesurface_changed.hpp#L718)
- [反射の計算方法](../../builds/build_sph/SPH_Functions.hpp#L449)

**水面粒子**

- [水面粒子の圧力をゼロにするかどうか](not found)
- [補助粒子の設定はどうなっているか](../../include/Network.hpp#L562)

**その他**

- [密度を更新するかどうか](../../builds/build_sph/SPH_Functions.hpp#L543)
...
[./SPH_Functions.hpp#L573](./SPH_Functions.hpp#L573)
