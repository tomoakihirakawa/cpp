...
data = {
    ...
    "C_CFL_velocity": 0.25,  # dt = C_CFL_velocity*h/Max(U)
    ...
    "mu": 0.001005,
    # -------------------------------------------------------- #
    "C_Tait": 13,#10.*math.sqrt(2.*9.81*H),  # テイトの式
    # ---------------------- 人口粘性係数 ---------------------- 
    "C_artificial_viscousity_alpha": 0.007/1466.*13.,
...
data = {
    ...
    "ignore":True,
    "scale": [1/10000, 0, 0, 0],  # モデルがmm単位なのでメートルに変換,
    "translate": [0, 0, 2],  # モデルがmm単位なのでメートルに変換,
    "depth_list": [-particle_spacing/2.],
    "volume_of_a_particle": volume_of_a_particle,
    "density": density,
}
