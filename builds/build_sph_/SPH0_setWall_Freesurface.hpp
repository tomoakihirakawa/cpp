...
void setCorrectionMatrix_gradient(networkPoint *A, const auto &all_nets) {
...
void setCorrectionMatrix_laplacian(networkPoint *A, const auto &all_nets) {
...
#pragma omp single nowait
         if (p->isCaptured)
            setCorrectionMatrix_gradient(p, all_nets);
...
#pragma omp single nowait
         if (p->isCaptured)
            setCorrectionMatrix_laplacian(p, all_nets);
}
//! -------------------------------------------------------------------------- */
