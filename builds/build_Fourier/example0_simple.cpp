...
$$
f(t) = \sum_{n=-\infty}^{\infty} c_n \exp(i n W t),\quad
c_n = \frac{1}{T} \int_{-\frac{T}{2}}^{\frac{T}{2}} f(t) \exp(-i n W t) \, dt, \quad W = \frac{2\pi}{T}
$$
...
$$
\begin{align*}
\int_{-\infty}^{\infty} \cos(x) e^{-i\omega x} \, dx
&= \int_{-\infty}^{\infty} \frac{e^{-ipx} + e^{ipx}}{2} \cdot e^{-i\omega x} \, dx \\
&= \frac{1}{2} \int_{-\infty}^{\infty} \left( e^{-i(p + \omega)x} + e^{i(p - \omega)x} \right) dx \\
...
$$
f(t) = \sum_{n=0}^{N-1} c_n \exp(i n \omega^\ast t), \quad c_n =\frac{1}{T^\ast} \int_{0}^{T^\ast} f(t) \exp(-i n \omega^\ast t) \, dt, \quad \omega^\ast = \frac{2\pi}{T^\ast}
$$
...
\begin{equation}
\begin{aligned}
\sum_{n=0}^{N-1}{c_n} \exp\left( i n \frac{2 \pi}{N} \kappa \right)&=N\sum_{n=0}^{N-1}{\frac{1}{N} \sum_{k=0}^{N-1} \left[ f_k \exp\left( -i n \frac{2 \pi}{N} k \right) \right]
} \exp\left( i n \frac{2 \pi}{N} \kappa \right)\\
&=N\sum_{n=0}^{N-1}{\frac{1}{N} \sum_{k=0}^{N-1} \left[ f_k \exp\left( -i n \frac{2 \pi}{N} k \right) \right]
} \exp\left( i n \frac{2 \pi}{N} \kappa \right)\\
&=N\frac{1}{N} f_\kappa \\
