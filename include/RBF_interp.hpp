...
public:
  ...
  {
    this->scale = RBFscale(A_IN);
    this->phi = [this](const V_d &x, const V_d &a) {auto r=Norm(x-a); auto e=1./this->scale; return sqrt((e*r)*(e*r) + 1.); };
    this->dphid = [this](const V_d &x, const V_d &a) {auto r=Norm(x-a); auto e=1./this->scale; return e*e*(x-a)/sqrt((e*r)*(e*r) + 1.); };
    this->w = weight(A_IN, V_IN);
  };
