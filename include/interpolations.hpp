...
class interpolationCenterTriangleQuadIDW12 : public interpolationTriangle {
  ...
  public:
   ...
   V_d dNdt0(const double &t0, const double &t1) const override {
      V_d ret = {-3 - 2 * t0 * (-1 + (-1 + t1) * t1) * (9 + (-1 + t1) * t1) + t1 * (-5 + t1 * (3 - 2 * (-2 + t1) * t1)) + (-42 - (-1 + t1) * t1 * (1 + (-1 + t1) * t1 * (-55 + 38 * (-1 + t1) * t1))) * std::pow(t0, 2) + 2 * (24 + (-1 + t1) * t1 * (-1 + 2 * (-1 + t1) * t1) * (-23 + 11 * (-1 + t1) * t1)) * std::pow(t0, 3) + (-27 + (-1 + t1) * t1 * (-47 + (-1 + t1) * t1 * (102 + (-1 + t1) * t1 * (13 + 42 * (-1 + t1) * t1)))) * std::pow(t0, 4) - 2 * (-3 + (-1 + t1) * t1 * (-5 + (-1 + t1) * t1 * (30 + (-1 + t1) * t1 * (17 + 5 * (-1 + t1) * t1)))) * std::pow(t0, 5) - 3 * (-1 + t1) * t1 * (-1 + (-1 + t1) * t1) * (1 + 6 * (-1 + t1) * t1) * std::pow(t0, 6) * std::pow(1 + (-1 + t1) * t1, 2), (-1 + (-1 + t1) * t1) * (3 + t1 * (-1 + 2 * t1 * (-7 + 3 * t1))) + (-42 + t1 * (67 + t1 * (93 + t1 * (5 - t1 * (-1 + 4 * t1) * (28 + 3 * (-6 + t1) * t1))))) * std::pow(t0, 2) + 2 * (24 + t1 * (-65 + t1 * (53 + t1 * (-149 + t1 * (56 + t1 * (100 + t1 * (-91 - 4 * (-7 + t1) * t1))))))) * std::pow(t0, 3) + 2 * (3 + t1 * (-11 + t1 * (41 + t1 * (-159 + t1 * (288 + t1 * (-354 + t1 * (317 + t1 * (-197 + t1 * (83 + t1 * (-19 + 2 * t1)))))))))) * std::pow(t0, 5) + 2 * t0 * (9 + t1 * (-4 + t1 * (-45 + t1 + (32 + t1 * (-13 + 2 * t1)) * std::pow(t1, 2)))) + std::pow(t0, 4) * (-27 + t1 * (98 + t1 * (-215 + t1 * (578 + t1 * (-665 + t1 * (478 + t1 * (-310 + t1 * (161 - 50 * t1 + 6 * std::pow(t1, 2))))))))) + 3 * t1 * std::pow(t0, 6) * (-1 + std::pow(t1, 2) * (11 - 11 * t1 + std::pow(t1, 3))) * std::pow(1 + (-1 + t1) * t1, 2), 6 - 5 * t1 + 2 * t0 * (-1 + (-1 + t1) * t1) * (18 + t1 * (-34 + t1 * (2 + t1 * (3 + 2 * t1)))) + (84 + t1 * (-96 + t1 * (-151 + t1 * (103 + t1 * (83 + t1 * (-68 + 3 * t1 * (-3 + 4 * t1))))))) * std::pow(t0, 2) - 2 * (48 + t1 * (-64 + t1 * (-53 + t1 * (11 + t1 * (109 + t1 * (-82 + t1 * (7 + 4 * (-1 + t1) * t1))))))) * std::pow(t0, 3) + 2 * (-6 + t1 * (-12 + t1 * (100 + t1 * (-190 + t1 * (214 + t1 * (-169 + t1 * (86 + t1 * (-23 + t1 * (2 + t1 * (-1 + 2 * t1)))))))))) * std::pow(t0, 5) + std::pow(t0, 4) * (54 + t1 * (-53 + t1 * (-144 + t1 * (163 + t1 * (-34 + t1 * (45 + t1 * (-79 + t1 * (23 + 4 * t1 - 6 * std::pow(t1, 2))))))))) + (-21 + t1 * (13 + 2 * (5 - 3 * t1) * t1)) * std::pow(t1, 2) + 3 * (-1 + t1) * t1 * (6 + (-6 + t1) * t1) * std::pow(t0, 6) * (-1 + t1 + std::pow(t1, 2)) * std::pow(1 + (-1 + t1) * t1, 2), 6 + 13 * t1 - 2 * t0 * (-1 + (-1 + t1) * t1) * (-18 + t1 * (2 + t1 * (31 + t1 * (-41 + 2 * t1)))) + (84 + t1 * (-32 + t1 * (-312 + t1 * (265 + t1 * (214 + t1 * (-179 + 4 * (11 - 3 * t1) * t1)))))) * std::pow(t0, 2) + 2 * (-48 + t1 * (76 + t1 * (119 + t1 * (-147 + t1 * (10 + t1 * (-163 + t1 * (201 + 4 * (-19 + t1) * t1))))))) * std::pow(t0, 3) + (54 + t1 * (-139 + t1 * (-8 + t1 * (-100 + t1 * (266 + t1 * (128 + t1 * (-324 + t1 * (160 + t1 * (-31 + 6 * t1))))))))) * std::pow(t0, 4) - 2 * (-1 + t1) * (-6 + t1 * (10 + t1 * (12 + t1 * (94 + t1 * (-177 + t1 * (214 + t1 * (-185 + t1 * (100 + t1 * (-35 + 2 * t1))))))))) * std::pow(t0, 5) + (6 + t1 * (-8 + t1 * (-11 + 6 * t1))) * std::pow(t1, 2) + 3 * (-1 + t1) * t1 * (-2 + t1 * (4 + (-1 + t1) * t1 * (-23 + 2 * t1))) * std::pow(t0, 6) * std::pow(1 + (-1 + t1) * t1, 2), 4 * (-1 + (-1 + t1) * t1) * (3 + (-1 + t1) * t1) - 2 * t0 * (-1 + (-1 + t1) * t1) * (24 + (-1 + t1) * t1 * (57 + 4 * (-1 + t1) * t1)) + (-72 + t1 * (266 + t1 * (-65 + 3 * t1 * (-116 + t1 * (13 - 18 * (-3 + t1) * t1))))) * std::pow(t0, 2) + 4 * (12 + (-1 + t1) * t1 * (79 + 2 * (-1 + t1) * t1 * (-27 + (-1 + t1) * t1 * (23 + 2 * (-1 + t1) * t1)))) * std::pow(t0, 3) + 2 * (-6 + (-1 + t1) * t1 * (-66 + (-1 + t1) * t1 * (160 + (-1 + t1) * t1 * (19 + 20 * (-1 + t1) * t1)))) * std::pow(t0, 4) - 2 * (-1 + t1) * t1 * (-1 + (-1 + t1) * t1 * (145 + (-1 + t1) * t1 * (155 + (-1 + t1) * t1 * (63 + 4 * (-1 + t1) * t1)))) * std::pow(t0, 5) - 3 * (-1 + t1) * t1 * (-2 + (-1 + t1) * t1 * (-25 + 2 * (-1 + t1) * t1)) * std::pow(t0, 6) * std::pow(1 + (-1 + t1) * t1, 2), -2 * t0 * (-1 + (-1 + t1) * t1) * (-24 + t1 * (51 + t1 * (-80 + t1 * (33 + 2 * t1)))) + (72 + t1 * (-280 + t1 * (385 + t1 * (209 + t1 * (-441 + t1 * (167 + 4 * t1 * (-10 + 3 * t1))))))) * std::pow(t0, 2) + (-48 + 2 * t1 * (196 + t1 * (-361 + t1 * (153 + t1 * (-170 + t1 * (329 + t1 * (-219 + 4 * t1 * (11 + t1)))))))) * std::pow(t0, 3) + (12 + t1 * (-231 + t1 * (416 + t1 * (-132 + t1 * (232 + t1 * (-564 + t1 * (432 + t1 * (-128 + (23 - 6 * t1) * t1)))))))) * std::pow(t0, 4) - 2 * t1 * (-29 + t1 * (6 + t1 * (211 + t1 * (-466 + t1 * (580 + t1 * (-504 + t1 * (297 + t1 * (-108 + t1 * (17 + 2 * t1))))))))) * std::pow(t0, 5) - (-1 + (-1 + t1) * t1) * (12 + t1 - 13 * std::pow(t1, 2) + 6 * std::pow(t1, 3)) + 3 * (-1 + t1) * t1 * (2 + t1 * (17 + t1 * (-40 + t1 * (17 + 2 * t1)))) * std::pow(t0, 6) * std::pow(1 + (-1 + t1) * t1, 2), t0 * t1 * std::pow(-1 + t1, 2) * (14 * (-1 + (-1 + t1) * t1) + t0 * (62 + t1 * (20 + t1 * (-62 + 21 * t1))) + (92 + t1 * (-93 + 2 * t1 * (30 + t1 * (-41 - 11 * (-3 + t1) * t1)))) * std::pow(t0, 3) + 2 * (-19 + t1 * (28 + t1 * (-20 + t1 * (8 + t1 * (4 + 3 * (-2 + t1) * t1))))) * std::pow(t0, 4) + 2 * std::pow(t0, 2) * (-54 + t1 * (20 + t1 * (17 + t1 - 6 * std::pow(t1, 2)))) + 3 * std::pow(t0, 5) * (2 + t1 + 3 * (-2 + t1) * std::pow(t1, 2)) * std::pow(1 + (-1 + t1) * t1, 2)), t0 * (-1 + t1) * std::pow(t1, 2) * (t0 * (-41 + t1 * (-41 + t1 * (-1 + 21 * t1))) + 2 * (22 + t1 * (33 + t1 * (16 + t1 * (-23 + 6 * t1)))) * std::pow(t0, 2) - (21 + t1 * (65 + 2 * t1 * (-5 + t1 * (19 + 11 * (-2 + t1) * t1)))) * std::pow(t0, 3) + (4 + 2 * t1 * (16 + t1 * (-13 + t1 * (24 + t1 * (-19 - 3 * (-4 + t1) * t1))))) * std::pow(t0, 4) + 14 * (1 + t1 - std::pow(t1, 2)) + 3 * t1 * (-2 + 3 * (-1 + t1) * t1) * std::pow(t0, 5) * std::pow(1 + (-1 + t1) * t1, 2)), -(pow(t1, 2) * (5 + (-3 + t1) * t1 * (-1 + 2 * t1) - 2 * t0 * (-1 + (-1 + t1) * t1) * (-8 + t1 * (-3 + 2 * t1)) + (14 + t1 * (64 - t1 * (3 + t1 * (57 + 4 * (-7 + t1) * t1)))) * std::pow(t0, 2) + (4 + 2 * t1 * (-49 + t1 * (14 + (-2 + t1) * t1 * (-1 + 4 * (-3 + t1) * t1)))) * std::pow(t0, 3) + (-11 + t1 * (71 + t1 * (-43 + t1 * (71 + t1 * (-117 + t1 * (73 + t1 * (-19 + 2 * t1))))))) * std::pow(t0, 4) - 2 * (-2 + t1 * (6 + t1 * (14 + t1 * (-31 + t1 * (38 + t1 * (-37 + t1 * (24 + t1 * (-11 + 2 * t1)))))))) * std::pow(t0, 5) + 3 * (-1 + t1) * t1 * (2 + t1 * (-7 + 2 * t1)) * std::pow(t0, 6) * std::pow(1 + (-1 + t1) * t1, 2))), -((-1 + t0) * t1 * (-5 + t1 * (-3 + (7 - 2 * t1) * t1) + 3 * t0 * (7 + t1 * (5 + t1 * (-9 + 2 * t1))) + (-27 + 4 * (-3 + t1) * (-1 + t1) * t1 * (-2 + (-2 + t1) * t1)) * std::pow(t0, 2) + (5 - 2 * t1 * (-27 + t1 * (10 + (-2 + t1) * t1 * (-13 + 4 * t1)))) * std::pow(t0, 3) + (12 + t1 * (-81 + t1 * (131 + t1 * (-127 + t1 * (89 + t1 * (-41 + (13 - 2 * t1) * t1)))))) * std::pow(t0, 4) + 3 * (-1 + t1) * (2 + t1 * (-7 + 2 * t1)) * std::pow(t0, 5) * std::pow(1 + (-1 + t1) * t1, 2))), -((-1 + t0) * (-1 + t1) * (3 + 3 * t0 * (5 + 2 * t1) * (-1 + (-1 + t1) * t1) - (21 + 2 * t1 * (7 + t1 * (-2 + (-2 + t1) * t1 * (9 + 4 * t1)))) * std::pow(t0, 3) + std::pow(t0, 4) * (6 + t1 * (15 + t1 * (-27 + t1 * (9 + t1 * (-9 + t1 * (-5 + t1 - 2 * std::pow(t1, 2))))))) + std::pow(t0, 2) * (27 + 4 * (-1 + t1) * t1 * (2 + t1) * (-3 + std::pow(t1, 2))) - t1 * (-5 + t1 + 2 * std::pow(t1, 2)) + 3 * t1 * (-3 + t1 * (3 + 2 * t1)) * std::pow(t0, 5) * std::pow(1 + (-1 + t1) * t1, 2))), -(pow(-1 + t1, 2) * ((-5 + t0 * (5 + 9 * t0 * (1 + t0))) * t1 * std::pow(-1 + t0, 3) - 3 * (-1 + 2 * t0) * std::pow(-1 + t0, 4) - std::pow(-1 + t0, 2) * (1 + 9 * t0 * (-2 + t0 + 4 * std::pow(t0, 3))) * std::pow(t1, 2) + (-1 + t0) * (2 + t0 * (-4 + t0 * (11 + t0 * (-41 + 6 * t0 * (-3 + 11 * t0))))) * std::pow(t1, 3) + t0 * (-4 + t0 * (8 + t0 * (-34 + t0 * (33 + 8 * (8 - 9 * t0) * t0)))) * std::pow(t1, 4) + (4 + t0 * (-8 + t0 * (-1 + 6 * t0 * (-4 + 7 * t0)))) * std::pow(t0, 2) * std::pow(t1, 5) - (-8 + t0 * (5 + 6 * t0 * (1 + t0))) * std::pow(t0, 3) * std::pow(t1, 6) + (-2 + (10 - 9 * t0) * t0) * std::pow(t0, 4) * std::pow(t1, 7) + 2 * (-2 + 3 * t0) * std::pow(t0, 5) * std::pow(t1, 8)))};
      return ret / (12 * std::pow(1 + t1 + t0 * (-2 + t1 - std::pow(t1, 2)) - std::pow(t1, 2) + std::pow(t0 + t0 * (-1 + t1) * t1, 2), 2));
   };
   V_d dNdt1(const double &t0, const double &t1) const override {
      V_d ret = {-(t0 * (-1 + 2 * t1) * (1 + t0 * (-3 + t0 + 2 * t0 * (-1 + t1) * t1 * (-15 + 7 * (-1 + t1) * t1) + (6 - 4 * (-1 + t1) * t1 * (-25 + (-1 + t1) * t1)) * std::pow(t0, 2) + (-9 - (-1 + t1) * t1 * (120 + (-1 + t1) * t1 * (25 + 12 * (-1 + t1) * t1))) * std::pow(t0, 3) + (1 + (-1 + t1) * t1) * (-1 + 3 * (-1 + t1) * t1 * (-3 + 2 * (-1 + t1) * t1 * (3 + (-1 + t1) * t1))) * std::pow(t0, 5) + std::pow(t0, 4) * (5 - 6 * t1 * (10 - 11 * t1 + (5 + 2 * (-3 + t1) * t1) * std::pow(t1, 3)))))), t0 * (2 * (-11 + t0 * (12 + 7 * t0)) * t1 * std::pow(-1 + t0, 3) - (-4 + t0 * (5 + t0)) * std::pow(-1 + t0, 4) + (-3 + 2 * t0 * (21 + t0 * (16 + 3 * t0 * (-23 + 6 * t0)))) * std::pow(-1 + t0, 2) * std::pow(t1, 2) - 2 * (-1 + t0) * (-6 + t0 * (-5 + t0 * (13 + t0 * (130 + t0 * (-187 + 46 * t0))))) * std::pow(t1, 3) + (6 + t0 * (-11 + 2 * t0 * (-47 + 3 * t0 * (-2 + t0 * (86 + 17 * (-5 + t0) * t0))))) * std::pow(t1, 4) + 2 * t0 * (2 + t0 * (27 - t0 * (17 + t0 * (175 - 202 * t0 + 30 * std::pow(t0, 2))))) * std::pow(t1, 5) + (-12 + t0 * (30 + t0 * (135 + (-196 + t0) * t0))) * std::pow(t0, 2) * std::pow(t1, 6) + 4 * (-2 + t0 * (-9 + t0 * (20 + 3 * t0))) * std::pow(t0, 3) * std::pow(t1, 7) - 3 * (-2 + t0 * (9 + 2 * t0)) * std::pow(t0, 4) * std::pow(t1, 8) + 2 * (2 + t0) * std::pow(t0, 5) * std::pow(t1, 9)), t0 * (pow(-1 + t0, 4) * (-17 + 6 * std::pow(t0, 2)) - 4 * t1 * std::pow(-1 + t0, 3) * (1 + (-17 + 9 * t0) * std::pow(t0, 2)) + (3 + t0 * (-22 + t0 * (104 + t0 * (-182 + 57 * t0)))) * std::pow(-1 + t0, 2) * std::pow(t1, 2) - 2 * (-1 + t0) * (6 + t0 * (5 + t0 * (-1 + 2 * t0) * (15 + t0 * (-38 + 3 * t0)))) * std::pow(t1, 3) + (-6 + t0 * (-9 + t0 * (4 + t0 * (12 + t0 * (49 + (16 - 69 * t0) * t0))))) * std::pow(t1, 4) + 2 * t0 * (2 + t0 * (-9 + t0 * (-11 + t0 * (20 + t0 * (-50 + 57 * t0))))) * std::pow(t1, 5) + (12 + t0 * (26 + t0 * (-51 + (56 - 85 * t0) * t0))) * std::pow(t0, 2) * std::pow(t1, 6) + 4 * (-2 + t0 * (3 + t0 * (2 + 9 * t0))) * std::pow(t0, 3) * std::pow(t1, 7) - 3 * (2 + t0 * (3 + 4 * t0)) * std::pow(t0, 4) * std::pow(t1, 8) + 2 * (2 + t0) * std::pow(t0, 5) * std::pow(t1, 9)), t0 * (-2 * (11 + 2 * t0 * (21 + t0 * (-14 + 3 * t0))) * t1 * std::pow(-1 + t0, 3) + (1 + 2 * t0 * (2 + t0)) * std::pow(-1 + t0, 4) - std::pow(-1 + t0, 2) * (6 + t0 * (54 + t0 * (-311 + 78 * t0 + 51 * std::pow(t0, 2)))) * std::pow(t1, 2) + 2 * (-1 + t0) * (6 + t0 * (49 + t0 * (42 + t0 * (-104 + t0 * (-167 + 138 * t0))))) * std::pow(t1, 3) + (6 - t0 * (-53 + t0 * (69 + 2 * t0 * (137 + t0 * (86 + 3 * t0 * (-161 + 83 * t0)))))) * std::pow(t1, 4) + 2 * t0 * (-2 + t0 * (20 + t0 * (121 + t0 * (18 + t0 * (-445 + 264 * t0))))) * std::pow(t1, 5) - 2 * (6 + t0 * (45 + t0 * (3 + 10 * t0 * (-26 + 17 * t0)))) * std::pow(t0, 2) * std::pow(t1, 6) + 4 * (2 + t0 * (-6 + t0 * (-41 + 33 * t0))) * std::pow(t0, 3) * std::pow(t1, 7) + 3 * (2 + (15 - 13 * t0) * t0) * std::pow(t0, 4) * std::pow(t1, 8) + 4 * (-1 + t0) * std::pow(t0, 5) * std::pow(t1, 9)), -(t0 * (-1 + 2 * t1) * (16 + t0 * (-77 + 4 * (-2 + t1) * (-1 + t1) * t1 * (1 + t1) + 2 * t0 * (73 + (-1 + t1) * t1 * (-22 + 9 * (-1 + t1) * t1)) - 2 * (67 + (-1 + t1) * t1 * (-115 + 2 * (-1 + t1) * t1 * (-5 + 2 * (-1 + t1) * t1))) * std::pow(t0, 2) + 2 * (28 - (-1 + t1) * t1 * (173 + 2 * (-1 + t1) * t1 * (38 + 3 * (-1 + t1) * t1))) * std::pow(t0, 3) + (-5 + 2 * (-1 + t1) * t1 * (109 + 2 * (-1 + t1) * t1 * (38 + (-1 + t1) * t1 * (3 + (-1 + t1) * t1)))) * std::pow(t0, 4) + 2 * (1 + (-1 + t1) * t1) * (-1 + (-1 + t1) * t1 * (-24 + (-1 + t1) * t1 * (3 + (-1 + t1) * t1))) * std::pow(t0, 5)))), t0 * (-2 * (-1 + t0 * (-69 + 5 * t0 * (7 + 3 * t0))) * t1 * std::pow(-1 + t0, 3) - (11 + t0 * (-17 + 2 * t0)) * std::pow(-1 + t0, 4) + (1 + 9 * t0) * (6 + t0 * (-20 + t0 * (-19 + 23 * t0))) * std::pow(-1 + t0, 2) * std::pow(t1, 2) - 2 * (-1 + t0) * (6 + t0 * (49 + t0 * (-2 + t0 * (46 + t0 * (-367 + 232 * t0))))) * std::pow(t1, 3) + (-6 + t0 * (-33 + t0 * (49 + 2 * t0 * (67 + t0 * (251 + 47 * t0 * (-13 + 6 * t0)))))) * std::pow(t1, 4) - 2 * t0 * (2 + t0 * (16 + t0 * (65 + t0 * (84 + t0 * (-401 + 210 * t0))))) * std::pow(t1, 5) + 2 * (6 + t0 * (17 + t0 * (3 + 2 * t0 * (-74 + 43 * t0)))) * std::pow(t0, 2) * std::pow(t1, 6) + 4 * (2 + t0 * (6 + (13 - 9 * t0) * t0)) * std::pow(t0, 3) * std::pow(t1, 7) + 3 * (-2 + (-3 + t0) * t0) * std::pow(t0, 4) * std::pow(t1, 8) + 4 * (-1 + t0) * std::pow(t0, 5) * std::pow(t1, 9)), (-1 + t1) * std::pow(t0, 2) * (7 + 7 * t1 * (-3 + (-1 + t1) * t1) + 2 * t0 * (-15 + t1 * (52 + t1 * (-6 + t1 * (-15 + 7 * t1)))) - 2 * (-25 + t1 * (95 + t1 * (-42 + t1 * (-4 + t1 * (2 + t1))))) * std::pow(t0, 2) + (15 + t1 * (-53 + t1 * (-5 + t1 * (99 + t1 * (-119 + t1 * (77 + 3 * (-7 + t1) * t1)))))) * std::pow(t0, 4) + 2 * (-1 + t1) * (1 + (-1 + t1) * t1) * std::pow(t0, 5) * (1 + (-13 + 3 * t1 * (4 + (-2 + t1) * t1)) * std::pow(t1, 2)) - 2 * std::pow(t0, 3) * (20 + t1 * (-78 + t1 * (41 + 5 * t1 - 7 * std::pow(t1, 3) + 6 * std::pow(t1, 4))))), t1 * std::pow(t0, 2) * (-7 * (2 + t1 * (-2 + (-2 + t1) * t1)) + 2 * t0 * (23 + t1 * (-23 + t1 * (-9 + t1 * (-13 + 7 * t1)))) + 2 * (-27 + t1 * (12 + t1 * (32 + t1 * (14 + (-7 + t1) * t1)))) * std::pow(t0, 2) + 2 * (13 + t1 * (20 + t1 * (-76 + t1 * (55 + t1 * (-55 + (29 - 6 * t1) * t1))))) * std::pow(t0, 3) + 2 * t1 * (1 + (-1 + t1) * t1) * std::pow(t0, 5) * (3 + t1 + (-17 + 3 * t1 * (6 + (-3 + t1) * t1)) * std::pow(t1, 2)) - std::pow(t0, 4) * (4 + t1 * (38 + t1 * (-96 + t1 * (78 + t1 * (-56 + 14 * t1 + 3 * std::pow(t1, 3))))))), -((-1 + t0) * t0 * t1 * (-10 + t1 + (-18 + t1 * (-45 + 2 * t1 * (1 + t1) * (15 + 2 * (-4 + t1) * t1))) * std::pow(t0, 2) + (-2 + t1 * (77 - 2 * t1 * (46 + t1 * (-38 + t1 * (43 + t1 * (-21 + 4 * t1)))))) * std::pow(t0, 3) + t1 * (1 + (-1 + t1) * t1) * (-6 + (-2 + t1) * t1 * (-19 + t1 * (21 + t1 * (-9 + 4 * t1)))) * std::pow(t0, 5) - 2 * (-2 + t1) * std::pow(t1, 2) + t0 * (26 + t1 + (6 + t1 * (-13 + 4 * t1)) * std::pow(t1, 2)) + std::pow(t0, 4) * (4 + t1 * (-28 + t1 * (8 + t1 * (23 + t1 * (-12 + 13 * t1 - 2 * std::pow(t1, 3)))))))), -(t0 * std::pow(-1 + t0, 2) * (5 + t1 * (-4 + 3 * t1) + t0 * (-13 + 8 * t1) + (9 + 2 * t1 * (7 + t1 * (-17 + (5 - 2 * t1) * t1))) * std::pow(t0, 2) + (1 - 2 * t1 * (18 + t1 * (-35 + t1 * (23 + 2 * (-6 + t1) * t1)))) * std::pow(t0, 3) + (1 + (-1 + t1) * t1) * (-2 + t1 * (16 + t1 * (-21 + t1 * (-1 + 5 * t1)))) * std::pow(t0, 4))), t0 * std::pow(-1 + t0, 2) * (4 + t1 * (-2 + 3 * t1) - t0 * (5 + 8 * t1) + (-5 + 2 * t1 * (20 + t1 * (-14 + (3 - 2 * t1) * t1))) * std::pow(t0, 2) + (9 + 2 * t1 * (-21 + t1 * (18 + t1 * (-5 + 2 * t1 * (1 + t1))))) * std::pow(t0, 3) + (1 + (-1 + t1) * t1) * (-3 + t1 * (9 + t1 * (6 + t1 * (-19 + 5 * t1)))) * std::pow(t0, 4)), -((-1 + t0) * t0 * (-1 + t1) * (-7 + t1 * (-3 + 2 * (-1 + t1) * t1) + t0 * (24 + t1 * (10 + t1 * (-9 + t1 * (-3 + 4 * t1)))) - (27 + t1 * (29 + 2 * t1 * (-20 + t1 * (3 + 2 * (-2 + t1) * t1)))) * std::pow(t0, 2) + (7 + t1 * (61 + 2 * t1 * (-40 + t1 * (4 + t1 * (2 + (3 - 4 * t1) * t1))))) * std::pow(t0, 3) + (6 + t1 * (-60 + t1 * (93 + t1 * (-35 + (-1 + t1) * t1 * (17 + 2 * (-6 + t1) * t1))))) * std::pow(t0, 4) + (-1 + t1) * (1 + (-1 + t1) * t1) * (3 + t1 * (-15 + t1 * (6 + t1 * (11 + t1 * (-3 + 4 * t1))))) * std::pow(t0, 5)))};
      return ret / (12 * std::pow(1 + t1 + t0 * (-2 + t1 - std::pow(t1, 2)) - std::pow(t1, 2) + std::pow(t0 + t0 * (-1 + t1) * t1, 2), 2));
   };
};
